...
Game.Launch=function()
{
	...
	'<div class="listing">'+loc("Cookie Clicker is a javascript game by %1 and %2.",['<a href="//cookieclicker.ee" target="_blank">Orteil</a>','<a href="//cookieclicker.ee" target="_blank">Opti</a>'])+'</div>'+
	(App?'<div class="listing">'+loc("Music by %1.",'<a href="https://twitter.com/C418" target="_blank">C418</a>')+'</div>':'')+
	//'<div class="listing">We have an <a href="https://discord.com/invite/GxGdP9YZju" target="_blank">official Discord</a>, as well as a <a href="http://forum.dashnet.org" target="_blank">forum</a>; '+
	'<div class="listing">'+(EN?
		'We have an <a href="https://discord.com/invite/GxGdP9YZju" target="_blank">official Discord</a>; if you\'re looking for help, you may also want to visit the <a href="https://www.reddit.com/r/CookieClicker" target="_blank">subreddit</a> or the <a href="https://cookieclicker.wikia.com/wiki/Cookie_Clicker_Wiki" target="_blank">wiki</a>.<br>News and teasers are usually posted on Orteil\'s <a href="https://orteil42.tumblr.com/" target="_blank">tumblr</a> and <a href="https://twitter.com/cookieclickeree" target="_blank">twitter</a>.'
		:
		loc("Useful links: %1, %2, %3, %4.",[
		'<a href="https://discord.com/invite/GxGdP9YZju" target="_blank" class="highlightHover smallBlackButton">Discord</a>',
		'<a href="https://cookieclicker.wikia.com/wiki/Cookie_Clicker_Wiki" target="_blank" class="highlightHover smallBlackButton">wiki</a>',
		'<a href="https://cookieclicker.tumblr.com/" target="_blank" class="highlightHover smallBlackButton">tumblr</a>',
		'<a href="https://twitter.com/cookieclickeree" target="_blank" class="highlightHover smallBlackButton">twitter</a>',
		]))
	+'</div>'+
	...
	'<div class="listing">&bull; added link to <a href="https://discord.com/invite/GxGdP9YZju" target="_blank">official Discord server</a></div>'+
		...
		Game.GrabDataResponse = function(response)
{
    ...
    */
    ...
    try {
        ...
        var sponsors = Game.customGrandmaNames.slice(0, Game.heralds);
        for (var i = sponsors.length + 1; i <= Game.heralds; i++) {
            sponsors.push('Sponsor ' + i);
        }
        
        var sponsorsList = sponsors.length > 0 ? 'Sponsor: ' + sponsors.join(', ') : 'No sponsors yet';

        var topBar = l('topBar');
        var heraldsDiv = l('heralds');
        
        if (topBar && heraldsDiv) {
            var sponsorDiv = l('sponsor');
            if (!sponsorDiv) {
                sponsorDiv = document.createElement('div');
                sponsorDiv.id = 'sponsor';
                topBar.insertBefore(sponsorDiv, heraldsDiv.nextSibling);
            }
            sponsorDiv.innerHTML = '<marquee onmouseover="this.stop();" onmouseout="this.start();" id="vip" behavior="scroll" direction="left" scrollamount="5">' + sponsorsList + '</marquee>';
        }
    } catch(e) {
        console.error('Error in GrabDataResponse:', e);
    }
}
